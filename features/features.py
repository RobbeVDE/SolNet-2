...
ft_phys = ['temperature_1_5m', 'PoA', "is_day", "CS_power", 'relative_humidity_1_5m', 'diffuse_surface_SW_flux', 'direct_surface_SW_flux', 'downward_surface_SW_flux', 'T_PV'] # , 'P_24h_shift', "wind_speed_10m", "total_cloud_amount", "month_sin", "month_cos", "hour_sin", "hour_cos"
