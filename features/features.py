...
ft_no_phys_sa = ['downward_surface_SW_flux','P_24h_shift', 'direct_surface_SW_flux', 'diffuse_surface_SW_flux', 'relative_humidity_1_5m', 'temperature_1_5m',  "wind_speed_10m",  "month_sin", "month_cos", "hour_sin", "hour_cos", "total_cloud_amount", "pressure_MSL"]
ft_phys_sa = ['PoA', "P_24h_shift", 'downward_surface_SW_flux', "is_day", 'relative_humidity_1_5m', 'diffuse_surface_SW_flux', 'direct_surface_SW_flux',  'T_PV',  "wind_speed_10m",  "month_sin", "month_cos", "hour_sin", "hour_cos", "total_cloud_amount", "pressure_MSL"]
